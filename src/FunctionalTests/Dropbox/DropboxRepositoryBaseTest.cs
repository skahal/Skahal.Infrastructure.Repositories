...
using Skahal.Infrastructure.Repositories.Dropbox;
using Skahal.Infrastructure.Repositories.FunctionalTests;
...
namespace Skahal.Infrastructure.Repositories.FunctionalTests
{
    ...
    public class DropboxRepositoryBaseTest
    {
        ...
        {
            var target = new DropboxRepositoryBase<SimpleDataStub> ("U5jjMlKt6vcAAAAAAAAbNAowdxZDwMfx5Nh0U4d3J-s", "DropboxRepositoryBaseTest");
            return target;
        }
    }
}
